...
Use the printing routine for say 100 iterations, e.g. prseci 100. Please note that the released code has log scale and your graphs will look differently than below one. 
